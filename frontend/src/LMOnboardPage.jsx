...
const LMOnboardPage = ({ setCurrentPage, setOnboardingData }) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.detail || 'Failed to save the model.');
      }

      const newModel = await response.json();
      setOnboardingData(newModel); // This might still be useful for other parts of the app
      setCurrentPage('model-details'); // Navigate to the details page
    } catch (error) {
